---
title: "Lagring av teikn med UTF-8"
belongs_to_chain: "Lagring av data"
figures_to_include:
---

I dag har datamaskinene vorte mykje kraftigare, noko som tillèt oss å bruka lengre bitkoder, og dermed ha mange fleire teikn. *ASCII* har derfor vorte erstatta av ein ny standard som heiter *UTF-8*. Kor mange teikn finst i den nye standarden? I 2023 hadde omtrent 150.000 teikn fått UTF-8-en *sin*-kode. men kvart år blir standarden utvida med nye teikn, og det finst nok bitkoder til over 1 million teikn!

Eigentleg finst fleire liknande standardar (*UTF-8*, *UTF-16* og *UTF-32*) som har samlenemninga *Unicode* (namnet kjem frå *universal encoding*). Forskjellen på dei ulike versjonane er lengda på bitkodene. Med *UTF-8* blir eit teikn koda som ein *bytesekvens*. Ein *byte* består av åtte bitar, så eit døme på ein bytesekvens er:
